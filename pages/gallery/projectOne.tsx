            ...
            <div className="col-half">
              <div className="content">
                ...
                >
                  ...
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (49).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (50).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (51).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (52).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (53).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (54).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (55).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (56).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (57).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (58).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (59).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (60).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (63).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (64).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (65).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (66).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (67).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (68).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (69).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (70).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (71).jpg"
                      alt="Project One image"
                    />
                  </div>
                  <div className="img-wrapper">
                    <img
                      src="/gallery/projectOne/projectOne (72).jpg"
                      alt="Project One image"
                    />
                  </div>
                </Carousel>
