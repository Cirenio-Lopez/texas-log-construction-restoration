              ...
              <div className="content">
                ...
                >
                  ...
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (15).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (16).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (17).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (18).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (19).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (20).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (21).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (22).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (23).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (24).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (25).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (26).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                  <div className="img-wrapper">
                    {" "}
                    <img
                      src="/gallery/projectSeven/projectSeven (27).jpg"
                      alt="Project Seven image"
                    />
                  </div>
                </Carousel>
